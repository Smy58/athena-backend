...
const SCHEDULE_HISTORY = [
  { day: 'СБ', date: '5 июл', name: 'Испытание Красной Луны', meta: 'Мастер: Арман · 18:00 · завершён', typeLabel: 'Кампейн' },
  { day: 'ВС', date: '29 июн', name: 'Похитители снов', meta: 'Мастер: Диана · 15:00 · для новичков', typeLabel: 'Ваншот' },
  { day: 'СБ', date: '22 июн', name: 'Ночь открытых дверей «Афина»', meta: 'Все мастера · 17:00 · Алматы', typeLabel: 'Ивент' },
  { day: 'ВС', date: '15 июн', name: 'Тайна Медного Квартала', meta: 'Мастер: Лера · 14:00 · 3–5 игроков', typeLabel: 'Кампейн' },
  { day: 'СБ', date: '8 июн', name: 'Турнир импровизации', meta: 'Мастер: Данияр · 16:00 · открытый набор', typeLabel: 'Ивент' },
];
